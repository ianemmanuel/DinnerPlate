            ...
            <NavigationMenuItem>
              ...
              <NavigationMenuContent>
                <div className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                  <Link href="/categories" className="block space-y-1 rounded-md p-3 hover:bg-accent">
                  ...
                  <Link href="/deals" className="block space-y-1 rounded-md p-3 hover:bg-accent">
                    <div className="text-sm font-medium">🤑 Deals</div>
                    <p className="text-sm text-muted-foreground">Browse to find the best deals</p>
                  </Link>
                    <Link href="/festivals" className="block space-y-1 rounded-md p-3 hover:bg-accent">
